...
---------------------------------------------------------------------------------------
	...
	DefineMission( 6000, "Перерождение Феникса ", 1300 )--реберн стандарт
...
-----------------------------------------------реберн
	...
	DefineMission(6001,"Очистим мир от демонов ",1302)--реберн стандарт
...
----------------------------
	...
	--Пропавший священный огонь (Офицер связи)
	DefineMission( 6250, "Пропавший священный огонь ", 1306 )
	MisBeginTalk("<t>Я полагаю, что священный огонь был похищен <r Песчанными бандитами (1065,3137)>, которые находятся за пределами города Шайтан. Поторопись найти их.")
	MisBeginCondition(NoMission, 1306)
	MisBeginCondition(NoRecord, 1306)
	MisBeginCondition(NoRecord, 1307)
	...
	MisNeed(MIS_NEED_DESP, "Офицер связи (871,3580) просит убить 10 песчанных бандитов.")
	MisNeed(MIS_NEED_KILL, 45, 10, 10, 10)

	MisHelpTalk("<t>Песчанные бандиты находятся за пределами города Шайтан, поторопись!")	
	MisResultTalk("<t>Отличная работа! Теперь принеси гнилое дерево и письмо кузнецу Башу в замок Ледыни. Только он сможет изготовить другой священный факел.")
	MisResultCondition(HasMission, 1306)
	...
	--Зажгите новый факел (Кузнец Баш)
	DefineMission( 6251, "Зажгите новый факел ",1307 )
	MisBeginTalk("<t>Отличная работа! Мы наконец-то нашли гнилое дерево, которое пропало много лет назад, но, чтобы изготовить новый факел, мне требуется больше предметов. Можешь принести их мне?")
	MisBeginCondition(NoMission, 1307)
	MisBeginCondition(HasRecord, 1306)
	...
	MisNeed( MIS_NEED_DESP, "Собери 15 ясеневых бревен и 10 кусков кристальной руды. Не забудь захватить <r гнилое дерево>.Отнесите все кузнецу Башу в замок Ледыни (1344,529).")
	...
	MisResultTalk( "<t>Дай взглянуть.")
	MisHelpTalk( "<t>Мне просто нужно, чтобы ты собрал 15 ясеневых бревен и 10 слитков кристальной руды. Это так сложно?")
	MisResultCondition( HasMission, 1307)
	...
	--Зажгите новый факел (Кузнец Баш)
	DefineMission( 6252, "Зажгите новый факел ",1308 )
	MisBeginTalk("<t>Теперь предметов достаточно, но, видишь ли я старею, я голоден и хочу пить. Поможешь найти для меня 10 фиников и 10 порций экстракта солода? После того, как я поем, я смогу работать.")
	...
	MisNeed( MIS_NEED_DESP, "<r Кузнец Баш(1344,529)> из замка Ледыни просит собрать <r10 фиников> и <r10 брикетов снежной травы>, и принести их ему.")
	...
	MisResultTalk( "<t>Ты очень сильно помог.")
	MisHelpTalk( "<t>Ты же можешь это сделать, не так ли?")
	...
	--Зажгите новый факел (Кузнец Баш)
	DefineMission( 6253, "Зажгите священный огонь ",1309 )
	MisBeginTalk( "<t>Священный факел готов! Отнеси священный факел Офицеру Связи. Я думаю, он до сих пор в городе Шайтан (871,3580). Не забудьте поместить факел в 1-ую ячейку инвентаря ")
	MisBeginCondition(NoRecord, 1309 )
	...
	MisNeed(MIS_NEED_DESP, "Принеси священный факел Офицеру связи в город Шайтан (871,3580) ")
	MisHelpTalk("<t>Ты должен передать священный факел Офицеру связи до того, как он покинет город Шайтан. Он в (871,3580).")
	MisResultCondition( AlwaysFailure )
	
	--Зажгите новый факел (Офицер связи)
	DefineMission( 6254, "Зажгите священный огонь ",1309, COMPLETE_SHOW )
	MisBeginCondition(AlwaysFailure )
	MisResultTalk( "<t>Отлично, ты вернулся с факелом!")
	...
	--Любящее сердце (Офицер связи)
	DefineMission( 6255, "Любящее сердце ",1310 )
	MisBeginTalk( "<t>Только тот, кто обладает благородными качествами, может зажечь священный огонь. Тебе нужно пройти через ряд испытаний, чтобы доказать, что у тебя любящее сердце. Ты должен поместить факел в инвентарь перед тем, как согласиться на испытания.")
	...
	MisNeed(MIS_NEED_DESP, "Отправляйся в Аскарон и поговори с Барабеем (994,1234)")
	MisHelpTalk("<t>Поспеши найти туриста - Барабея (994,1234)")
	MisResultCondition( AlwaysFailure )
	
	--Любящее сердце (Странник - барабей)
	DefineMission( 6256, "Любящее сердце ",1310, COMPLETE_SHOW )
	MisBeginCondition(AlwaysFailure )
	MisResultTalk( "Я здесь уже давно. наконец-то кто-то вспомнил обо мне.<t>")
	...
	--Любящее сердце 2(Странник - барабей)
	DefineMission( 6257, "Любящее сердце 2",1311 )
	MisBeginTalk( "<t>В мире пиратов есть много людей, которым требуется помощь. Я надеюсь, ты сможешь навестить их.")
	...
	MisNeed(MIS_NEED_DESP, "Найди Хассана (1254,3491) на территории Магического океана и поговори с ним.")
	MisHelpTalk("<t>Спасибо, что пришел навестить меня. Теперь ты должен найти Хассана (1254,3491) на территории Магического океана ")
	MisResultCondition( AlwaysFailure )
	
	--Любящее сердце 2(Принц-тритон Хассан)
    DefineMission( 6258, "Любящее сердце 2 ",1311, COMPLETE_SHOW )
	MisBeginCondition(AlwaysFailure )
	MisResultTalk( "<t>Здравствуй. Уже давно никто не приходил сюда.")
	...
	--Любящее сердце 3(Принц-тритон Хассан)
    DefineMission( 6259, "Любящее сердце 3 ",1312 )
	MisBeginTalk( "<t>Я вспомнил, что встречал одинокого Оператора порта Грегори в Великом синем океане.")
	...
	MisNeed(MIS_NEED_DESP, "Нужно найти Грегори, работника порта, в Бухте Сальва (194,1715)")
	MisHelpTalk("<t>Отправляйся в Бухту Сальва (194,1715), что на территории Великого синего океана. Поговрите с Грегори, работником порта.")
	MisResultCondition( AlwaysFailure )
	
	--Любящее сердце 3(Диспетер порта - Грегори)
	DefineMission( 6260, "Любящее сердце 3 ",1312, COMPLETE_SHOW )
	MisBeginCondition(AlwaysFailure )
	MisResultTalk( "<t>Ты на самом деле пришел ко мне?")
	...
	--Любящее сердце 4(Диспетер порта - Грегори)
	DefineMission( 6261, "Любящее сердце 4 ",1313 )
	MisBeginTalk( "<t>В Веснограде живет мужчина средних лет по имени Билл. Он что-то шепчет целыми днями. Ему может понадобиться помощь.")
	...
	MisNeed(MIS_NEED_DESP, "Отправляйся в Весноград чтобы навестить Билла (3235,2550).")
	MisHelpTalk("<t>Почему ты до сих пор здесь? Поторопись найти Билла (3235,2550).")
	MisResultCondition( AlwaysFailure )
	
	--Любящее сердце 4(Билл)
	DefineMission( 6262, "Любящее сердце 4 ",1313, COMPLETE_SHOW )
	MisBeginCondition(AlwaysFailure )
	MisResultTalk( "<t>Очень мило, что ты пришел меня навестить.")
	...
	--Любящее сердце 5(Билл)
	DefineMission( 6263, "Любящее сердце 5 ",1314 )
	MisBeginTalk( "<t>Да, я знаю, тебе нужно доказать, что у тебя любящее сердце. Теперь тебе также нужно найти Портальщика в Абаддон.")
	MisBeginCondition(NoRecord, 1314 )
	...
	MisNeed(MIS_NEED_DESP, "Отправляйся на поиски телепортера в Преисподнюю на Карибские острова(690,1043).")
	MisHelpTalk("<t>Поторопись, чтобы найти Портальщика в Абаддон на Острове Сокровищ (690,1043).")
	MisResultCondition( AlwaysFailure )
	
	--Любящее сердце 5(Портальщик Абаддона)
	DefineMission( 6264, "Любящее сердце 5 ",1314, COMPLETE_SHOW )
	MisBeginCondition(AlwaysFailure )
	MisResultTalk( "<t>Каждый день я вижу, как приходят и уходят воины. Наконец-то появился преданный и заботливый человек.")
	...
	--Любящее сердце 6(Портальщик Абаддона)
	DefineMission( 6265, "Любящее сердце 6 ",1315 )
	MisBeginTalk( "<t>Ты доказал искреннюю заботу, но этого не достаточно. Вернись к Офицеру Связи, он даст следущие указания!")
	MisBeginCondition(NoRecord, 1315 )
	...
	MisNeed(MIS_NEED_DESP, "Вернись к Офицеру Связи(871,3580), чтобы узнать, что он хочет сказать!")
	MisHelpTalk("<t>Связной офицер находится в (871,3580), поторопись, чтобы попасть туда!")
	MisResultCondition( AlwaysFailure )

	--Любящее сердце 6(Офицер Связи)
	DefineMission( 6266, "Любящее сердце 6 ",1315, COMPLETE_SHOW )
	MisBeginCondition(AlwaysFailure )
	MisResultTalk( "<t>Неважно, в игре или в реальной жизни, Я надеюсь, что ты сможешь хорошо позаботиться как о себе, так и о других. Наслаждайся каждым днем! Тебя ждут другие испытания, крепись!")
	...
	--Новое испытание(Офицер Связи)
	DefineMission( 6267, "Новое испытание ",1316 )
	MisBeginTalk( "<t>Докажи как ты храбр!")
	MisBeginCondition(NoRecord, 1316)
	...
	MisNeed(MIS_NEED_DESP, "Поговори с распорядителем Хаоса (1374,529) в Ледыни, она скажет, как выполнить задание!")
	MisHelpTalk("<t>Сначала найди распорядителя Хаоса (1374,529) в Ледыни. Затем, после окончания испытаний, возвращайся назад.")
	MisResultCondition( AlwaysFailure )
	
	--Новое испытание(Управляющий хаоса)	
	DefineMission( 6268, "Новое испытание ",1316, COMPLETE_SHOW )
	MisBeginCondition(AlwaysFailure )
	MisResultTalk( "<t>Вас рекомендовал Офицер Связи, не так ли? Давай начнем прямо сейчас ")
	...
	--Сердце Бесстрашия 1(Управляющий хаоса)
	DefineMission( 6269, "Сердце Бесстрашия 1 ",1317 )
	MisBeginTalk( "<t>Это задание должно показать, насколько ты храбр. Я дам карту Бесстрашия, чтобы записать твой бой. Ты должен победить 10 врагов и принести карту Бесстрашия Офицеру Связи(871,3580). Готов?")
	MisResultBagNeed(1)
	MisBeginCondition(NoRecord, 1317)
	...
	MisCancelAction(SysteamNotice, "Ты отменил задание!")
	--MisCancelAction(SysteamNotice, "ёГИООсОЮВ·ЁЦРВ¶П")
	MisResultCondition( AlwaysFailure )
	MisNeed(MIS_NEED_DESP, "Когда в карте Бесстрашия будет указано, что ты убил 10 врагов, ты сможешь завершить испытание. Поговори с Офицером Связи (871,3580) в городе Шайтан ")
	MisHelpTalk("<t>Когда в карте Бесстрашия будет указано, что ты убил 10 врагов, ты сможешь завершить испытание. Кроме того, ты должен взять с собой священный факел.")
	MisBeginBagNeed(1)
	
	--Сердце Бесстрашия 1(Офицер связи)
	DefineMission( 6270, "Сердце Бесстрашия 1 ",1317)
	MisBeginCondition(AlwaysFailure )
	MisResultTalk("<t>Отличная работа! Я удивился, что ты смог закончить испытание так быстро! Теперь продолжай выполнять следующее испытание.")	
	...
	--Сердце Верности(Офицер связи)
	DefineMission( 6271, "Сердце Верности ",1318 )
	MisBeginTalk( "<t>Самое сильное чувство - это бескорыстная преданность.")
	MisBeginCondition(NoRecord, 1318)
	...
	MisNeed(MIS_NEED_DESP, "Поговори с шахтером Дранки (296,57) в Серебряной шахте 2. Он расскажет об испытании подробнее.")
	MisHelpTalk("<t>Отправляйся на поиски шахтера Дранки(296,57) в Серебряную шахту. Выполнив задание, возвращайся ко мне.")
	MisResultCondition( AlwaysFailure )
	
	--Сердце Верности(Шахтер Дранки)
	DefineMission( 6272, "Сердце Верности ",1318, COMPLETE_SHOW )
	MisBeginCondition(AlwaysFailure )
	MisResultTalk("<t>Почему так поздно? Луна уже почти опустилась за гору.")	
	...
	--Сердце Верности(Шахтер Дранки)	
	DefineMission( 6273, "Сердце Верности ",1319 )
	MisBeginTalk( "<t>Чтобы выполнить это задание, ты должен принести пожертвования священному пламени. Не приноси мне ерунду! Мне нужно 5 Эльфиских печатей!")
	MisBeginCondition(NoRecord, 1319)
	...
	MisNeed(MIS_NEED_DESP, "Шахтер Дранки (296,57) просит подарить ему 5 Эльфийских печатей.")	
	MisHelpTalk("<t>Знаешь, мы каждый день работаем не покладая рук. Ты должен пожертвовать нам 5 Эльфийских печатей! Это то, что мне нужно!")
	
	MisResultTalk("<t>Отлично, я очень люблю Эльфийские печати. Спасибо за помощь! Я сообщу Офицеру Связи о том, что ты сделал.")	
	...
	--Сердце Верности 2(Шахтер Дранки)
	DefineMission( 6274, "Сердце Верности 2 ",1320 )
	MisBeginTalk( "<t>Возвращайся к Офицеру Связи. Он знает, о том, что ты сделал, и хочет увидеть тебя вновь! ")
	...
	MisNeed(MIS_NEED_DESP, "Возвращайся в город Шайтан и поговори с Офицером Связи (871,3580). Он очень доволен работой ")
	MisHelpTalk("<t>Офицер Связи находится в городе Сатаны (871,3580)")
	MisResultCondition( AlwaysFailure )
	
	--Сердце Верности 2(Офицер Связи)
	DefineMission( 6275, "Сердце Верности 2",1320, COMPLETE_SHOW )
	MisBeginCondition(AlwaysFailure )
	MisResultTalk("<t>Рад увидеть тебя снова. Я слышал про шахтера Дранки. Ты внес щедрые пожертвования. Я ожидаю от тебя дальнейших подвигов.")	
	...
	--Сердце Мудрости(Офицер связи)
	DefineMission( 6276, "Сердце Мудрости ",1321 )
	MisBeginTalk( "<t>На небесах живет Богиня, которая обладает Величайшей мудростью (1755,908). Я говорил с ней о тебе, и она захотела с тобой встретиться. Ты можешь идти прямо сейчас. Далеко не каждому предоставляется такая возможность.")
	MisBeginCondition(NoRecord, 1321)
	...
	MisNeed(MIS_NEED_DESP, "Отправляйся на встречу с Богиней (1755,908). Она хочет встретиться с тобой.")
	MisHelpTalk("<t>Она находится на небесах (1755,908).")
	MisResultCondition( AlwaysFailure )
	
	--Сердце Мудрости(Богиня)
	DefineMission( 6277, "Сердце Мудрости ",1321, COMPLETE_SHOW )
	MisBeginCondition(AlwaysFailure )
	MisResultTalk("<t>Связной Офицер говорил о тебе. Я рада, что мы встретились.")	
	...
	--Сердце Мудрости 1(Богиня)
	DefineMission( 6278, "Сердце Мудрости 1 ",1322 )
	MisBeginTalk( "<t>Связной офицер попросил меня тебя проверить. Ты готов? Мне нужны следующие вещи: исцеляющее лекарство, которое оказывает лечебный эффект на трудноизлечимые раны, и немыслимый предмет для боксера. Если ты не сможешь достать 2 предмета, значит, ты глупее пьяницы.")
	MisBeginCondition(NoRecord, 1322)
	...
	MisHelpTalk("<t>Богиня(1755,908) хочет обладать исцеляющим лекарством, которое оказывает лечебный эффект на трудноизлечимые раны, и немыслимым предметом для боксера.")
	MisNeed(MIS_NEED_DESP, "Богиня хочет обладать исцеляющим лекарством, которое оказывает лечебный эффект на трудноизлечимые раны, и немыслимым предметом для боксера.")
	...
	MisResultTalk("<t>Ты очень умен, но у меня есть к тебе несколько вопросов. Если ты дашь правильные ответы на них, то сможешь завершить испытание!")
	...
	MisResultAction(SetRecord, 1322)
	
	
	--Огненный помост(Офицер связи)
	DefineMission( 6279, "Огненный помост ",1323 )	
	MisBeginTalk( "<t>Ты прошел четыре испытания, поэтому я дарую последний предмет - сердце Непоколебимости, которое дается только герою, который прошел 4 специальных испытания. Оно твое, возьми его. Теперь принеси все пять предметов и факел к Огненному помосту, который находится вблизи порта Шайтана.")
	...
	MisBeginBagNeed(1)
	MisCancelAction(SystemNotice, "Задание отменено!")
	--MisCancelAction(SystemNotice, "ёГИООсОЮВ·ЁЦРВ¶П")
	MisNeed(MIS_NEED_DESP, "Принеси Священный факел и 5 предметов к Огненному помосту. ") 
	MisHelpTalk("<t>Ты не можешь потерять любой предмет или факел, иначе у тебя ничего не получится.")
	MisResultCondition( AlwaysFailure )
	
	--Огненный помост(Огненный помост)
	DefineMission( 6280, "Огненный помост ",1323, COMPLETE_SHOW )	
	MisBeginCondition( AlwaysFailure )
	MisResultTalk("<t>Поздравляем! Ты прошел все пять испытаний!")	
	MisResultCondition(HasMission, 1323)		
	MisResultCondition(HasItem, 5842, 1)
	MisResultCondition(HasItem, 5797, 1)
	MisResultCondition(HasItem, 5798, 1)
	MisResultCondition(HasItem, 5799, 1)
	MisResultCondition(HasItem, 5800, 1)
