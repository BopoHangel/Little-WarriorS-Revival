-- Настройка свойств карты Затерянный Город 2 (abandonedcity2)
...
function get_map_entry_pos_abandonedcity2()  -- Расположение точки входа (координаты)
...
function init_entry(map)
    SetMapEntryMapName(map, "abandonedcity") 	-- Карта, на которой установлена точка входа на это карту
